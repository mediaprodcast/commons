...
const (
	ProbeService_GetMetadata_FullMethodName = "/probe.ProbeService/GetMetadata"
)
...
type ProbeServiceClient interface {
	GetMetadata(ctx context.Context, in *ProbeRequest, opts ...grpc.CallOption) (*ProbeResponse, error)
}
...
func (c *probeServiceClient) GetMetadata(ctx context.Context, in *ProbeRequest, opts ...grpc.CallOption) (*ProbeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProbeResponse)
	err := c.cc.Invoke(ctx, ProbeService_GetMetadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProbeServiceServer interface {
	GetMetadata(context.Context, *ProbeRequest) (*ProbeResponse, error)
...
func (UnimplementedProbeServiceServer) GetMetadata(context.Context, *ProbeRequest) (*ProbeResponse, error) {
...
func _ProbeService_GetMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProbeServiceServer).GetMetadata(ctx, req.(*ProbeRequest))
	}
